...
from VQABBoxpro.common.eval_utils import prepare_texts, init_model, eval_parser, computeIoU
from VQABBoxpro.conversation.conversation import CONV_VISION_VQABBoxpro

from VQABBoxpro.datasets.datasets.coco_caption import RefCOCOEvalData
...
model.eval()
CONV_VISION = CONV_VISION_VQABBoxpro
...
for dataset in args.dataset:
    for split in eval_dict[dataset]:
        ...
        VQABBoxpro_predict = defaultdict(list)
        resamples = []
        ...
        for images, questions, img_ids in tqdm(eval_dataloader):
            ...
            for answer, img_id, question in zip(answers, img_ids, questions):
                ...
                if re.match(pattern, answer):
                    VQABBoxpro_predict[img_id].append(answer)
                else:
        ...
        for img_id in refcoco_dict:
            ...
            bbox = item['bbox']
            outputs = VQABBoxpro_predict[img_id]
